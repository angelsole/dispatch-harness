...
GATE_ENV=(env -u IMPLEMENTER_PROVIDER -u IMPLEMENTER_MODEL -u IMPLEMENTER_EFFORT
          -u REVIEWER_MODEL -u REVIEWER_EFFORT -u HARNESS_OWNER -u HARNESS_CODEX_HOME_FALLBACK
          -u HARNESS_MAX_TURNS -u HARNESS_MAX_RESUMES
          -u HARNESS_SKIP_REVIEW -u HARNESS_REDISPATCH -u HARNESS_RESUME -u HARNESS_PUBLISH

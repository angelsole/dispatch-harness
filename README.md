...
| Frontend evidence: screenshots and optional video tied to the final commit, saved locally and attached to the PR when uploads are available; missing capture/upload is explicit | [Demo recordings](docs/operations.md#demo-recordings) |
